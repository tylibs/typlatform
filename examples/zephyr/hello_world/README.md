...
static void onHelloWorld(const Event *aEvent) { LOG_INF("Action onHelloWorld() called from TinyPlatform"); }
...
int main(void)
{
    ...
    while (true)
    {
        ...
        // Publish the HELLO_WORLD event.  The TinyPlatform will then look up this
        ...
        // is being sent with the event.    // publish an event to the TinyPlatform
...
[00:00:00.000,000] <wrn> main: Subscribe module 'main' to TinyPlatform
[00:00:00.000,000] <inf> main: Publish HELLO_WORLD event
[00:00:00.000,000] <inf> main: Action onHelloWorld() called from TinyPlatform
[00:00:01.010,000] <inf> main: Publish HELLO_WORLD event
[00:00:01.010,000] <inf> main: Action onHelloWorld() called from TinyPlatform
```
